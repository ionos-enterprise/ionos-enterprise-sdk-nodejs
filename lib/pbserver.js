...
**/	
	...
	// jason is { 'id': volume_id} , I don't know why this one instance is different
...
**/		
       // jason has to be empty {}
        ...
        startServer : function(dc_id,srv_id,callback){
                jason={}
                pbreq.is_command([ "datacenters",dc_id,"servers",srv_id,"start" ],jason,callback)
        },
       // jason has to be empty {}

        stopServer : function(dc_id,srv_id,callback){
                var jason={}
                pbreq.is_command([ "datacenters",dc_id,"servers",srv_id,"stop" ],jason,callback)
        },
       // jason has to be empty {}

        rebootServer : function(dc_id,srv_id,callback){
                var jason={}
                pbreq.is_command([ "datacenters",dc_id,"servers",srv_id,"reboot" ],jason,callback)
        }
